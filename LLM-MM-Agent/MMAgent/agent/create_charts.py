...
"""
    ...
    def create_charts_with_images(self, paper_content: str, chart_num: int, output_dir: str, user_prompt: str = '', data_files: list = None, data_columns_info: str = None):
        """
        Generate multiple charts with actual image files.

        Args:
            paper_content: Content describing what charts to create
            chart_num: Number of charts to generate
        ...
        print(f"\n{'='*60}")
        print(f"Generating {chart_num} charts with images")
        print(f"{'='*60}\n")
