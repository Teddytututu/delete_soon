...
class EmbeddingScorer:
    ...
    def score_method(self, query: str, methods: List[dict]) -> List[dict]:
        ...
        # CRITICAL FIX: Use [:, 0, :self.dimension] to slice embedding dimension, NOT batch dimension
        # Old buggy code: outputs.last_hidden_state[:, 0][:self.dimension] sliced wrong dimension
